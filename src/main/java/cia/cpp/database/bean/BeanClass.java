...
/*
	...
	public boolean containsKey(Object key) {
		final int index = key instanceof String ? beanInfo.fieldNames.indexOf(key) : -1;
		return index >= 0 && fieldValues.get(index) != null;
	}
	...
	public Object remove(Object key) {
		final int index = key instanceof String ? beanInfo.fieldNames.indexOf(key) : -1;
		return index >= 0 ? fieldValues.set(index, null) : null;
	}
